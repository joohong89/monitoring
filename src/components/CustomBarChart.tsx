...
const CustomBarChart = ({data, seriesName, yAxisLabel}: {data: Array<ChartData>, seriesName: Array<series>, yAxisLabel: string}) => {
    return (
        <ResponsiveContainer aspect={2.75}>
            ...
            >
                ...
                <YAxis fill={"green"} label={{fill:"var(--color-text-primary)", value:yAxisLabel, angle: -90, position: 'left', offset: 30}} stroke={"var(--color-text-primary)"} />
